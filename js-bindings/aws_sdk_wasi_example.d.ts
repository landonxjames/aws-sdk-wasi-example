...
export type * as WasiHttpOutgoingHandler020 from './interfaces/wasi-http-outgoing-handler.js'; // import wasi:http/outgoing-handler@0.2.0
export type * as WasiHttpTypes020 from './interfaces/wasi-http-types.js'; // import wasi:http/types@0.2.0
...
export * as dataUploader from './interfaces/component-aws-sdk-wasi-example-data-uploader.js'; // export component:aws-sdk-wasi-example/data-uploader
